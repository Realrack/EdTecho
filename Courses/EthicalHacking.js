...
const EthicalHacking = ({ navigation }) => {
  press = (item) =>{
    if(item.id == 1){
      navigation.navigate('bash')
    }
    else if (item.id == 2){
      navigation.navigate('perl')
    }
    else if (item.id == 3){
      navigation.navigate('php')
    }
    else if (item.id == 4){
      navigation.navigate('ruby')
    }
    else{}
      ...
      <View style={styles.flatlistContainer}>
        <FlatList
          ...
          data={[
            {
              id: 1,
              image: require("../Photos/Bash.png"),
              name: "Bash",
            },
            {
              id: 2,
              image: require("../Photos/perl.png"),
              name: "Perl",
            },
            {
              id: 3,
              image: require("../Photos/php.png"),
              name: "PHP",
            },
            {
              id: 4,
              image: require("../Photos/ruby.png"),
              name: "Ruby",
            },
          ]}
          renderItem={({ item }) => {
